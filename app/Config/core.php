 ...
 */
	Configure::write('Error', array(
		...
		'level' => E_ALL & ~E_DEPRECATED & ~E_STRICT & ~E_USER_DEPRECATED,
		'trace' => true
	));
 ...
 */
	Configure::write('Security.salt', '0FATAxZxPn3whn8ajRrWAbrm+T5TbAoK6WIuvZvz');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '172651576607337703434656982172');
