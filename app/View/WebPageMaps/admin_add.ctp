...
<div class='page-header boxes'>
	...
	<!-- Option buttons -->
	<?php echo $this->element('admin/widgets/form/actions', array('cancelAction' => empty($configView['cancelAction']) ? $referer : Utility::redirect($configView['cancelAction'], empty($modelData) ? null : $modelData))); ?>
</div>
<!-- End header -->
